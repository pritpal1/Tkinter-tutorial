# Step1:import all functions from the tkinter 
from tkinter import *
from tkinter import messagebox 

#Step2: Function for clearing the contents of all text entry boxes 
def clearAll() : 
...
#Step3: function for checking error 
def checkError() : 
...
#Step4: function to calculate Age 
def calculateAge() : 

	# check for error ,if error is occur then return 
	value = checkError() 
	if value == -1 : 
		return
	else : 		
#Step5:take a value from the entry boxes get method returns current text as string 
...
#Step6:if birth date is greater then given birth_month then donot count this month and add 30 to the date so 
